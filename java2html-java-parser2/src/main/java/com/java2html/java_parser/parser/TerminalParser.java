...
public final class TerminalParser {
  ...
  /**
   * A {@link org.codehaus.jparsec.Parser} that succeeds only if the {@link org.codehaus.jparsec.Token} objects in the {@link java.util.List} are
   * adjacent.
   */
  ...
  /**
   * A {@link org.codehaus.jparsec.Parser} that parses all adjacent characters in {@code operator} as individual
   * {@link org.codehaus.jparsec.Token} and only succeeds if these tokens are adjacent. A {@code Token} representing
